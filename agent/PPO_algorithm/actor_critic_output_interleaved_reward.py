...
# Load the model
env = gym.make('navigation_discrete_action_interleaved_reward-v0')
state_dim = env.observation_space.shape[0]
action_dim = env.action_space.n
actor_critic = ActorCritic(state_dim, action_dim)
actor_critic.load_state_dict(torch.load('/home/user/PycharmProjects/Error/Revision/PPO/Interleaved_reward/Value_02_entropy_002_episode_4000/Agent' + str(seed_num) + '_nstep' + str(n_steps) + '/Agent' + str(seed_num) + '_model_' + str(episode_num) + '.pth'))
...
matlab_filename = 'Agent' + str(seed_num) + '_nstep' + str(n_steps) + '_episode' + str(episode_num) + '_actor_critic_outputs_interleaved_reward.mat'
